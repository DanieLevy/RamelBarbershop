 ...
 * 
 * Flow:
 * 1. Netlify scheduler triggers this function
 * 2. Function calls POST /api/cron/process-reminders
 * 3. Main app handles all reminder logic (SMS + Push)
 * 4. Function returns the result
 */
...
function getBaseUrl(): string {
  // Use the production URL or the deploy preview URL
