  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto">
        <div className="bg-background-card/95 backdrop-blur-xl p-4 rounded-2xl shadow-2xl border border-white/10">
          {/* Close Button - Top Right */}
          <button
            onClick={handleDismiss}
            className="absolute top-3 left-3 text-foreground-muted hover:text-foreground-light transition-colors p-1.5 rounded-full hover:bg-white/10"
            aria-label="סגור"
          >
            <X size={16} />
          </button>
          ...
          <div className="text-center">
            ...
            <p className="text-foreground-muted text-xs leading-relaxed mb-4 max-w-xs mx-auto">
